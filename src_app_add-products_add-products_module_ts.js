                ...
                return new Promise(resolve => {
                    ...
                    this.accessProviders.postData(body, 'process_add-products.php').subscribe((res) => {
                        if (res.success == true) {
                            ...
                            this.http.post('http://165.232.160.89/capstone-project/api/add_products_image.php', formData).subscribe((response) => {
                            ...
                            if (this.image2 != "") {
                                ...
                                this.http.post('http://165.232.160.89/capstone-project/api/add_image.php', formData).subscribe((response) => {
                                    console.log(response);
                                });
                            }
                            if (this.image3 != "") {
